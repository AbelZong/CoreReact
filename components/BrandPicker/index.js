...
export default React.createClass({
  ...
  render() {
    ...
    const styler = style ? {width: this.props.width || 92, ...style} : {width: this.props.width || 92}
    return (
      <div className={CN} style={styler}>
        <div className={styles.inputArea} onClick={this.handleSelect}>
          <Input value={this.state.name} placeholder='选择品牌' size={this.props.size || 'default'} className={styles.input} />
