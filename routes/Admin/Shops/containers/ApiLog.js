...
const ApiLog = React.createClass({
  ...
  render() {
    ...
    return (
      <div>
        <Modal style={styles.main} title={title} visible={visible} onCancel={this.handleCancel} footer={this.renderFooter()} confirmLoading={confirmLoading} width='70%'>
          <ZGrid className={styles.zgrid} onReady={this.handleGridReady}gridOptions={gridOptions} storeConfig={{ prefix: 'shop_apilog' }} columnDefs={defColumns} grid={this} height={600} />
        </Modal>
      </div>
    )
  }
